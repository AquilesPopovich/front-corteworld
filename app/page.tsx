...
export default function Home() {
  ...
  //   const CardsProductosLoading = dynamic(() => import('./ui/cards/productos/mapeoCards/CardsProductos'), {
  //     loading: () => (
  //       <div style={{ marginTop: '100px' }} className='inset-0 h-full w-fit sm:h-full sm:w-full bg-white'>
  ...
  //   return <CardsProductosLoading productos={[]} />;
  // }
